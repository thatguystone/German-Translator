...
) ENGINE=MyISAM AUTO_INCREMENT=565664 DEFAULT CHARSET=latin1 COLLATE=latin1_german2_ci;
...
CREATE TABLE `translations` (
  ...
  KEY `en_de` (`en`,`de`),
  KEY `en` (`en`)
) ENGINE=MyISAM AUTO_INCREMENT=387481 DEFAULT CHARSET=latin1 COLLATE=latin1_german2_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `verbs` (
  ...
  KEY `full_2` (`full`)
) ENGINE=MyISAM AUTO_INCREMENT=7800 DEFAULT CHARSET=latin1 COLLATE=latin1_german2_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2010-12-01 18:34:11
