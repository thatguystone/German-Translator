...
class verbTree(object):
	...
	def pruneAmbiguousWords(self, beAggressive):
		ret = []
		if (self.node != None):
			self.node.pruneAmbiguousWords(ret, self, beAggressive)
		return ret
...
class verbNode(object):
	...
	def pruneAmbiguousWords(self, ret, tree, beAggressive, parent = None):
		"""
		...
		self.child.pruneAmbiguousWords(ret, tree, beAggressive, self)
